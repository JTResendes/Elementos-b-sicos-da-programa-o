...
def notas(num):
    ...
    moeda_050 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1)) / 0.50
    moeda050_int = int(moeda_050)

    moeda_020 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1) - (moeda050_int * 0.50)) / 0.20
    moeda020_int = int(moeda_020)

    moeda_010 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1) - (moeda050_int * 0.50) - (moeda020_int * 0.20)) / 0.10
    moeda010_int = int(moeda_010)

    moeda_005 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1) - (moeda050_int * 0.50) - (moeda020_int * 0.20) - (
                             moeda010_int * 0.10)) / 0.05
    moeda005_int = int(moeda_005)

    moeda_002 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1) - (moeda050_int * 0.50) - (moeda020_int * 0.20) - (
                             moeda010_int * 0.10) - (moeda005_int * 0.05)) / 0.02
    moeda002_int = int(moeda_002)

    moeda_001 = (num - (nota50_int * 50) - (nota20_int * 20) - (nota10_int * 10) - (nota5_int * 5) - (
                moeda2_int * 2) - (moeda1_int * 1) - (moeda050_int * 0.50) - (moeda020_int * 0.20) - (
                             moeda010_int * 0.10) - (moeda005_int * 0.05) - (moeda002_int * 0.02)) / 0.01
    moeda001_int = int(moeda_001)

    print(
        f'{nota50_int} nota/s de 50, {nota20_int} nota/s de 20, {nota10_int} nota/s de 10, {nota5_int} nota/s 5, {moeda2_int} moeda/s de 2, {moeda1_int} moeda/s de 1, {moeda050_int} moeda/s de 0.50, {moeda020_int} moeda/s de 0.20, {moeda010_int} moeda/s de 0.10, {moeda005_int} moeda/s de 0.05, {moeda002_int} moeda/s de 0.02 e {moeda001_int} moeda/s de 0.01.')
